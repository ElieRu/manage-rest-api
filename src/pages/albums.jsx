...
export default function Albums () {
    ...
    return <section className="mt-5">
            <div className="mb-3 d-flex">
                <svg className="fs-1" style={{marginRight: '10px'}} xmlns="http://www.w3.org/2000/svg" viewBox="0 -32 576 576" width="1em" height="1em" fill="currentColor">
